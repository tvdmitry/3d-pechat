document.addEventListener("DOMContentLoaded", function () {
    ...
    function tabFunction(tabContainer) {
        ...
        let contents = tabContainer.siblings('.control_contents').find('.control_content');
    ...
    function tabPerformFunction(tabContainer) {
        ...
        let contents = tabContainer.siblings('.perform_contents').find('.perform_content');
    ...
    function initAccordion(selector) {
        ...
        accordion.find(".accordion_item:first-child .accordion_content").addClass('show');
        accordion.find(".accordion_item:first-child .accordion_header").addClass("active");
    ...
    if ($('.menu').length) {
        if ($(window).width() > 768) {
            $('.menu_item:has(.menu_content) .menu_title').on('mouseenter', function () {
        ...
        if ($(window).width() < 768) {
            $('.links_item:has(.menu) .link_title').off('click').on('click', function (e) {
                e.preventDefault();
                ...
                if ($menu.hasClass('is_open')) {
                    ...
                    $menu.addClass('is_open').css('height', $menu[0].scrollHeight + 'px');
                }
            });
            $('.menu_item:has(.menu_content) .menu_title').off('click').on('click', function (e) {
                e.preventDefault();
            ...
            $('.to_back').off('click').on('click', function (e) {
                e.preventDefault();
                $('.menu_content').removeClass('is_open')
            });
    ...
    if (document.querySelector('.portofilo_swiper')) {
        ...
        function updateSlidePosition() {
            ...
            let activeSlide = document.querySelector('.portofilo_swiper .swiper-slide-active');
            if (activeSlide) {
                let swiperWrapper = document.querySelector('.portofilo_swiper .swiper-wrapper');
                ...
                currentTranslateX = currentTranslateX ? parseInt(currentTranslateX[0]) : 0;
    ...
    if ($('.review_tabs').length) {
        $('.review_tab').click(function (e) {
            ...
            $(this).closest('.review_right').find('.review_content').fadeOut().removeClass('active')
            $(this).closest('.review_right').find('.review_content').eq($index).fadeIn()
        })
